...
export default function SectionWrapper(props: { children: any; header: string; title: string[]; id: string }) {
  const { children, header, title, id } = props;
  return (
    <section id={id} className='min-h-screen flex flex-col gap-10 mt-10'>
