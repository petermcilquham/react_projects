...
export default function ExerciseCard(props: { exercise: any; index: number }) {
  ...
  return (
    <div className='p-4 rounded-md flex flex-col gap-4 bg-slate-950 sm:flex-wrap'>
      <div className='flex flex-col flex-row items-center flex-wrap gap-x-4'>
        <h4 className='text-3xl inline sm:text-4xl md:text-5xl font-semibold text-slate-400'>0{index + 1}</h4>
        <h2 className='capitalize whitespace-nowrap truncate max-w-full text-lg sm:text-xl md:text-2xl flex-1 text-center'>
      ...
      <div className='grid grid-cols4 place-items-center gap-2'>
